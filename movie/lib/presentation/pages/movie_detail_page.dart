...
class MovieDetailPage extends StatefulWidget {
  ...
  @override
  _PageDetailMovieState createState() => _PageDetailMovieState();
}

class _PageDetailMovieState extends State<MovieDetailPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: const Key('movie_content_detail'),
...
class ContentDetailMovies extends StatefulWidget {
  final MovieDetail movie;
  late bool isAddedWatchlist;

  ContentDetailMovies(this.movie, this.isAddedWatchlist, {Key? key})
      : super(key: key);

  @override
  State<ContentDetailMovies> createState() => _ContentDetailMoviesState();
}

class _ContentDetailMoviesState extends State<ContentDetailMovies> {
  @override
  Widget build(BuildContext context) {
